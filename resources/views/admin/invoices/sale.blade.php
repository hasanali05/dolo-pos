                            ...
                            <td>
                                <table>
                                    <tr>
                                        ...
                                        <td> INV{{str_pad($data['id'], 6, '0', STR_PAD_LEFT)}}</td>
                                    </tr>
                                    <tr>
                                        <td class="ph-0 pv-0 w-4">
                                    ...
                                    <tr>
                                        ...
                                        <td class="bottom-solid"> {{$data['user'] ? $data['user']['name'] : '' }}</td>
                                    </tr>
                                    <tr>
                                        <td class="ph-0 pv-0 w-4">
                                    ...
                                    <tr>
                                        <td class="ph-0 pv-0 w-4">
                                            <b>Sale Date</b> <span class="float-right">:</span>
                                        </td>
                            ...
                            <td class="pv-0 ph-0">                                        
                                <table class="item-table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="item">
                                            <td class="item-serial">{{++$i}}</td>
                                            <td class="item-description">
                                                <b>{{$item['inventory']['product']['name']}}</b><br><br>
                                                {{$item['unique_code']}}
                                            </td>
                                            <td class="item-serial">{{$item['warranty_duration'] .' '. $item['warranty_type']}}</td>
                                            <td class="item-amount">{{$item['quantity']}}</td>
                                            <td class="item-amount">{{ number_format((float)$item['price'], 2, '.', '')}}</td>
                                            <td class="item-amount">{{ number_format((float)($item['quantity'] * $item['price']), 2, '.', '')}}</td>
                                        ...
                                        <td class="w-5">
                                            ...
                                            <p>TAKA:  
                                                <?php
                                                    ...
                                                    echo $f->format($data['amount'] + $data['commission']);
                                                ?>
                                            </p>
                                        </td>
                                        <td>
                                            <table>
                                                <tr>
                                                    ...
                                                    <td class="w-3 item-amount">{{number_format((float)$data['amount'], 2, '.', '')}}</td>
                                                </tr>
                                                <tr>
                                                    <td class="w-7">Add Vat</td>
                                                    <td class="w-3 item-amount">{{number_format((float)0, 2, '.', '')}}</td>
                                                </tr>
                                                <tr>
                                                    <td class="w-7">Add Convyance</td>
                                                    <td class="w-3 item-amount">{{number_format((float)$data['commission'], 2, '.', '')}}</td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="w-3 bottom-solid item-amount">{{number_format((float)0, 2, '.', '')}}</td>
                                                </tr>
                                                <tr>
                                                    <th class="w-7" style="text-align: left;">Net Payable Amount</th>
                                                    <th class="w-3 item-amount">{{number_format((float)($data['amount'] + $data['commission']), 2, '.', '')}}</th>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                                ...
                                <table>
                                    <tr>
                                        <td class="w-5" style=" border:1px solid #a7a7a7">
                                            ...
                                            <table>
                                                <tr>
                                                    <td class="w-7">Previous Due Amount</td>
                                                    <td class="w-3 item-amount">{{number_format((float)$data['customer']['previousDue'], 2, '.', '')}}</td>
                                                </tr>
                                                <tr>
                                                    <td class="w-7 bottom-dashed">Received Amount</td>
                                                    <td class="w-3 bottom-dashed item-amount">{{number_format((float)$data['payment'], 2, '.', '')}}</td>
                                                </tr>
                                                <tr>
                                                    <th class="w-7" style="text-align: left;">Current Due Amount</th>
                                                    <th class="w-3 item-amount">{{number_format((float)$data['customer']['due'], 2, '.', '')}}</th>
                                                </tr>
                                            </table>
                                        </td>
                                        <td></td>
