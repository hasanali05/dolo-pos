...
<!-- Mirrored from wrappixel.com/ampleadmin/ampleadmin-html/ampleadmin-sidebar/error-404.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 May 2019 05:45:39 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <div class="main-wrapper">
        ...
        <div class="error-box">
            <div class="error-body text-center">
                ...
                <a href="{{route('employee.index')}}" class="btn btn-danger btn-rounded waves-effect waves-light mb-5">Back to employee panel</a> </div>
        </div>
        <!-- ============================================================== -->
        <!-- Login box.scss -->
        <!-- ============================================================== -->
